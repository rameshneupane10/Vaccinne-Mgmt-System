...
#include<string.h>
#include<windows.h> 
#include<iomanip>						//	manipulate the output of C++ program.
#include<time.h>												
...
{
    cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 IMMUNIATION MANAGEMENT SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
    cout<<"\n\t\t\t*****************************************\n";
...
void Vaccine::erase()									// deletion part
{
	ifstream in;
	in.open("vaccinetrial.txt");
	int flag=0,p =0;
    char id[100];
    cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 IMMUNIZATION MANAGEMENT SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
    cout<<"\n\t\t\t*****************************************\n";
    cout<<"\t\t\t\t DATA DELETION";
    cout<<"\n\t\t\t*****************************************\n\n";
...
int password()//b
{
    ...
    pass[i] = '\0';
    srand(time(0));										//time header file is used for this funcion.
    cap=rand();											// rand is used for generating random numbers
    cout<<"\n\n\t\t\t\t\tCAPTCHA:-> "<<cap<<endl;
...
int main()
 {
    ...
    cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 IMMUNIZATION MANAGEMENT SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
	Sleep(2000);
    cout<<"\t\n\n Press any key to continue";Sleep(1000);cout<<"............  "<<endl;
    getch();
    B:
    system("cls");
    system("color E0");							
    ...
    if(k<1)
      ...
      do{
            cout<<"\n\n\t\t\xB3\xB2=\xB2=\xB2-\xB3 IMMUNIZATION MANAGEMENT SYSTEM  \xB3\xB2=\xB2=\xB2-\xB3\n\n"<<endl;
            menu();
            cout<<"\n\t\n\tWhich operation do you want to proceed : ";
            cin>>ch;
             Vaccine v1;
      switch(ch)
       {
         ...
         case 6:  system("cls");
                  ...
                  Sleep(3000);
                    exit(0);
         default: system("cls");
                  cout<<"\n\n\n\n\n\n\n\n\t\t\t\t\t\tPLEASE ENTER THE NO. GIVEN IN MENU!!";
                  Sleep(3000);
                  break;
       }
      }while(ch!=0);
